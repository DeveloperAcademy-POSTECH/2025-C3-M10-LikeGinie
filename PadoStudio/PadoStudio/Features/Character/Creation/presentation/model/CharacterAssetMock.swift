...
struct CharacterAssetMock {
    static let mockCharacterAssets: [CharacterAsset] = [
        ...
        CharacterAsset(part: .hair, color: "black", index: "06", imageName: "preview-hair-black-06"),
        CharacterAsset(part: .hair, color: "black", index: "07", imageName: "preview-hair-black-07"),
        ...
        CharacterAsset(part: .hair, color: "blond", index: "06", imageName: "preview-hair-blond-06"),
        CharacterAsset(part: .hair, color: "blond", index: "07", imageName: "preview-hair-blond-07"),
        ...
        CharacterAsset(part: .hair, color: "brown", index: "06", imageName: "preview-hair-brown-06"),
        CharacterAsset(part: .hair, color: "brown", index: "07", imageName: "preview-hair-brown-07"),
